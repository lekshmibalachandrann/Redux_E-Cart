  ...
  return (
    <div className='py-10 md:px-20 px-10 bg-violet-900 md:grid grid-cols-[repeat(1,2fr)_repeat(2,1fr)_repeat(1,2fr)] text-white'>
        ...
        <div>
            ...
            <p className='mt-5 text-justify'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Velit doloribus officia modi soluta nostrum eaque vero sunt facere blanditiis, odio possimus harum natus dolor. Voluptas assumenda possimus quae veritatis aperiam.</p>
        </div>
        <div className='md:flex justify-center mt-10 md:mt-0'>
            <div>
                <h3 className='text-3xl'>Links</h3>
               <Link to={'/home'}> <p className='mt-6'>Home</p></Link>
